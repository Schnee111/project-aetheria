...
import { preloadHowlAudio } from '../../hooks/useAudio';
...
export function LandingScreen({ hasSave, onStart, onContinue }: LandingScreenProps) {
  ...
  const preloadInitialAssets = async () => {
    try {
      await Promise.all([
        preloadHowlAudio('/assets/audio/sfx/rain-no-window.mp3'),
        preloadHowlAudio('/assets/audio/voice/chapter-1/scene-00/CH1_S00_D001.mp3'),
