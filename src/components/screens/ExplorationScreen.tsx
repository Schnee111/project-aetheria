            ...
            {activeMenu === 'main' && (
              ...
              >
                ...
                <ActionButton
                  icon={<Search size={20} />}
                  label="Investigasi"
                  desc={!visitedSceneIds.includes(exp.talkSceneId) ? t('investigation.locked') : 'Cari petunjuk'}
                ...
                <ActionButton
                  icon={<Zap size={20} />}
                  label={t("investigation.presentEvidence")}
                  desc={!exp.defaultPresentSceneId && !exp.presentEvidenceRoutes ? t('investigation.notAvailable') : !visitedSceneIds.includes(exp.talkSceneId) ? t('investigation.locked') : t('investigation.pressWithEvidence')}
