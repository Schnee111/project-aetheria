...
export const s03: Scene = // SCENE 3: THE REVELATION
{
  ...
  dialogues: [
    ...
    },
    {
      ...
      speaker: "lysthea",
      expression: "shocked",
      text: '"Hak Akses Mutlak... Otoritas inti penciptaan... Anda... Sang Arsitek Utama dari sepuluh ribu tahun lalu?"',
      textEn: '"Absolute Access... Authority of creation... You... The Grand Architect from ten thousand years ago?"',
    ...
    },
    {
      ...
      speaker: "narrator",
      expression: "neutral",
      text: 'Aku menatap wanita di depanku. Pancaran energi murni itu... tak salah lagi.',
      textEn: 'I gazed at the woman before me. That pure energy signature... unmistakable.',
      backgroundOverride: "ch1/cg_ch1_s04_lys_crying.webp",
      autoAdvance: true,
      unskippable: true,
    ...
    },
    {
      ...
      speaker: "aeterna",
      expression: "smile",
      text: '"Bangunlah. Lantainya penuh pecahan kaca. Lama tak berjumpa... Goddess of Order."',
      textEn: '"Stand up. The floor is full of glass shards. Long time no see... Goddess of Order."',
    ...
    },
    {
      ...
      speaker: "lysthea",
      expression: "shocked",
      text: '"Anda mengenali saya? Jika ingatan Anda utuh, mengapa Anda bersembunyi di sini?"',
      textEn: '"You recognize me? If your memory is intact, why were you hiding here?"',
      backgroundOverride: "ch1/cg_ch1_s04_aeterna_smile.webp",
      characterOverrides: { aeterna: "none", lysthea: "none", abyssal_assassin: "leave" },
      autoAdvance: true,
      unskippable: true,
    ...
    },
    {
      ...
      speaker: "aeterna",
      expression: "lazy",
      text: '"Tentu saja aku ingat. Walau sejujurnya, baru detik ini sihirmu membuka segel ingatanku yang tertidur."',
      textEn: '"Of course I remember. Though honestly, it took your magic just now to unseal my dormant memories."',
      backgroundOverride: "ch1/cg_ch1_s04_aeterna_smile.webp",
      characterOverrides: { aeterna: "none", lysthea: "none", abyssal_assassin: "leave" },
      autoAdvance: true,
      unskippable: true,
    ...
    },
    {
      ...
      speaker: "aeterna",
      expression: "neutral",
      text: '"Maaf membuatmu menunggu. Dan terima kasih sudah menjaga server ini tetap online sendirian, Lysthea."',
      textEn: '"Sorry to keep you waiting. And thank you for keeping this server online all alone, Lysthea."',
      backgroundOverride: "ch1/cg_ch1_s04_aeterna_smile.webp",
      characterOverrides: { aeterna: "none", lysthea: "none", abyssal_assassin: "leave" },
      autoAdvance: true,
      unskippable: true,
    ...
    },
    {
      ...
      speaker: "narrator",
      expression: "neutral",
      text: 'Mendengar itu, sang Grand Saintess menundukkan kepalanya, menyembunyikan isak tangis kelegaan.',
      textEn: 'Hearing that, the Grand Saintess bowed her head, hiding her sobs of relief.',
      backgroundOverride: "ch1/cg_ch1_s04_lys_crying.webp",
      autoAdvance: true,
      unskippable: true,
      autoAdvanceDelay: 5500,
    },
    {
      ...
      speaker: "lysthea",
      expression: "sad",
      text: '"Selama ini saya terus menjalankan Sistem. Namun akhir-akhir ini... Abyss menemukan celah keamanan."',
      textEn: '"I have kept the System running all this time. But recently... the Abyss found a security loophole."',
      backgroundOverride: "ch1/cg_ch1_s04_lys_crying.webp",
      characterOverrides: { aeterna: "none", lysthea: "none", abyssal_assassin: "leave" },
      autoAdvance: true,
      unskippable: true,
    ...
    },
    {
      ...
      speaker: "aeterna",
      expression: "sad",
      text: '"Tak ada sistem yang bertahan selamanya tanpa patch. Sayangnya, kekuatan asalku juga belum pulih."',
      textEn: '"No system lasts forever without a patch. Unfortunately, my original power has not recovered either."',
      backgroundOverride: "ch1/cg_ch1_s04_aeterna_authority.webp",
      characterOverrides: { aeterna: "none", lysthea: "none", abyssal_assassin: "leave" },
      autoAdvance: true,
      unskippable: true,
    ...
    },
    {
      ...
      speaker: "aeterna",
      expression: "cool",
      text: '"Yah... mari kita bereskan satu per satu."',
      textEn: '"Well... let us sort them out one by one."',
      backgroundOverride: "ch1/cg_ch1_s04_aeterna_smile.webp",
      characterOverrides: { aeterna: "none", lysthea: "none", abyssal_assassin: "leave" },
      autoAdvance: true,
      unskippable: true,
    ...
    },
    {
      ...
      speaker: "narrator",
      expression: "neutral",
      text: 'Mentari sore mulai menyingkirkan hawa iblis yang mencekik bengkel ini.',
      textEn: 'The afternoon sun began to clear the demonic aura choking this workshop.',
    ...
    },
    {
      ...
      speaker: "narrator",
      expression: "neutral",
      text: 'Hembusan anginnya membawaku kembali ke masa lalu... Ke era di mana Aetheria belum memiliki daratan.',
      textEn: 'Its breeze took me back to the past... To an era where Aetheria had no land.',
      backgroundOverride: "ch1/cg_ch1_s04_sunlight_window.png",
      autoAdvance: true,
      unskippable: true,
