...
export const s03: Scene = // SCENE 3: THE REVELATION
{
  ...
  dialogues: [
    ...
    },
    {
      ...
      speaker: "aeterna",
      expression: "neutral",
      text: '"Maaf telah membuatmu menunggu. Dan terima kasih sudah menjaga server-nya tetap online sendirian selama ini, Lysthea. Kerja yang bagus."',
      textEn:
    ...
    },
    {
      ...
      speaker: "narrator",
      expression: "neutral",
      text: "Mendengar permintaan maaf sederhana itu, sang Grand Saintess menundukkan kepalanya dalam-dalam, menyembunyikan isak tangis kelegaan di balik sikap elegannya.",
      textEn:
    ...
    },
    {
      ...
      speaker: "narrator",
      expression: "neutral",
      text: "Cahaya mentari sore perlahan menembus sisa-sisa jendela bengkel yang hancur, menyingkirkan awan badai dan hawa iblis yang sempat mencekik ruangan ini.",
      textEn:
