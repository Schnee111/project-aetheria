...
export const scenes: Scene[] = [
  ...
  // SCENE 1D: AETHERIA (Reincarnation Cinematic)
  {
    ...
    dialogues: [
      // ── Video 1: Planet (8s) ──
      { id: 'CH1_S01D_D001', speaker: 'narrator', expression: 'neutral', text: 'Aetheria.', textEn: 'Aetheria.', backgroundOverride: 'ch1/cg_aetheria_planet.mp4', audioSrc: '/assets/audio/sfx/ethereal_chime.ogg', autoAdvance: true, unskippable: true, autoAdvanceDelay: 3500 },
      { id: 'CH1_S01D_D002', speaker: 'narrator', expression: 'neutral', text: 'Sebuah dimensi di mana hukum fisika tunduk pada kehendak sihir.', textEn: 'A dimension where the laws of physics bow to the will of magic.', backgroundOverride: 'ch1/cg_aetheria_planet.mp4', autoAdvance: true, unskippable: true, autoAdvanceDelay: 3500 },
      // ── Video 2: Metropolis (8s) ──
      { id: 'CH1_S01D_D003', speaker: 'narrator', expression: 'neutral', text: 'Di sini, peradaban tidak dibangun dengan baja dan minyak.', textEn: 'Here, civilization is not built with steel and oil.', backgroundOverride: 'ch1/cg_aetheria_metropolis.mp4', autoAdvance: true, unskippable: true, autoAdvanceDelay: 3500 },
      { id: 'CH1_S01D_D004', speaker: 'narrator', expression: 'neutral', text: 'Melainkan dengan sirkuit siber dan kristal mana yang berdenyut energi.', textEn: 'But with cyber circuits and mana crystals pulsing with energy.', backgroundOverride: 'ch1/cg_aetheria_metropolis.mp4', autoAdvance: true, unskippable: true, autoAdvanceDelay: 3500 },
      // ── Video 3: Street (8s) ──
      ...
      { id: 'CH1_S01D_D006', speaker: 'narrator', expression: 'neutral', text: 'Ia adalah teknologi. Ia adalah napas kehidupan sehari-hari.', textEn: 'It is technology. It is the breath of everyday life.', backgroundOverride: 'ch1/cg_aetheria_street.mp4', autoAdvance: true, unskippable: true, autoAdvanceDelay: 3500 },
      // ── Video 4: Baby (8s) ──
      ...
      { id: 'CH1_S01D_D008', speaker: 'narrator', expression: 'neutral', text: 'Seorang anak kecil. Keluarga baru. Kehidupan kedua yang baru saja dimulai.', textEn: 'A small child. A new family. A second life, just beginning.', backgroundOverride: 'ch1/cg_isekai_baby.mp4', autoAdvance: true, unskippable: true, autoAdvanceDelay: 3500 }
    ],
    unlockEvidenceIds: [],
