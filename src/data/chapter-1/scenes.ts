...
export const scenes: Scene[] = [
  ...
  // SCENE 1B: BUMI (Truck Hit)
  {
    ...
    characters: [],
    dialogues: [
      { id: 'CH1_S01B_D001', speaker: 'system', expression: 'neutral', text: '*HONK!!!*', audioSrc: '/assets/audio/sfx/car_horn.ogg' },
      { id: 'CH1_S01B_D002', speaker: 'system', expression: 'neutral', text: '*CRASH!!!*', audioSrc: '/assets/audio/sfx/car_crash.ogg' }
    ],
    unlockEvidenceIds: [],
  ...
  // SCENE 1D: AETHERIA (Reincarnation Slideshow)
  {
    ...
    dialogues: [
      ...
      { id: 'CH1_S01D_D005', speaker: 'aeterna', expression: 'neutral', text: 'Aku dilahirkan kembali. Menjalani masa kecil di bawah asuhan orang tua angkatku yang hangat...', backgroundOverride: 'ch1/cg_parents_silhouette.webp', autoAdvance: true, autoAdvanceDelay: 3000 },
      { id: 'CH1_S01D_D006', speaker: 'aeterna', expression: 'neutral', text: 'Di bengkel kecil milik merekalah, aku belajar merangkai sirkuit Magitech pertamaku, dan menemukan tujuan hidup baruku: hidup santai tanpa lembur.', backgroundOverride: 'ch1/bg_magitech_learning.webp', autoAdvance: true, autoAdvanceDelay: 3500 }
    ],
    unlockEvidenceIds: [],
  ...
  // SCENE 2B: AETHERIA (Bel Berbunyi - Kedatangan Elf)
  {
    ...
    dialogues: [
      ...
      { id: 'CH1_S02B_D003', speaker: 'aeterna', expression: 'sigh', text: 'Aku menghela napas, meletakkan ujung telunjukku langsung pada kristal sirkuit mana yang hangus itu.', backgroundOverride: 'ch1/bg_mechanic_shop_door_pov.webp' },
      ...
      { id: 'CH1_S02B_D005', speaker: 'aeterna', expression: 'neutral', text: 'Tiga detik. Bawa pulang.', backgroundOverride: 'ch1/bg_mechanic_shop_door_pov.webp' },
      ...
      { id: 'CH1_S02B_D008', speaker: 'aeterna', expression: 'smug', text: 'Menjadi Arsitek Sistem di Bumi ternyata memberiku semacam "Cheat Skill" di dunia ini. Logika pemrograman dan sirkuit sihir pada dasarnya adalah hal yang sama.', backgroundOverride: 'ch1/bg_mechanic_shop_corner.webp', characterOverrides: { elf_neighbor: 'leave' } },
      { id: 'CH1_S02B_D009', speaker: 'aeterna', expression: 'lazy', text: 'Tapi menggunakannya untuk hal-hal besar terlalu merepotkan. Aku hanya ingin hidup santai, jauh dari drama lembur.', backgroundOverride: 'ch1/bg_mechanic_shop_corner.webp' }
    ],
    unlockEvidenceIds: [],
    nextSceneId: 'CH1_S03',
  },
  ...
  // SCENE 3: TAMU TAK DIUNDANG
  {
    ...
    dialogues: [
      ...
      { id: 'CH1_S03_D004', speaker: 'aeterna', expression: 'sigh', text: 'Aku membuka pintu kayu bengkelku. Seorang wanita berjubah basah kuyup berdiri menggigil di bawah hujan. Wajahnya terlihat sangat panik.', backgroundOverride: 'ch1/cg_ch1_s03_lys_arrive.webp', characterOverrides: { aeterna: 'none', lysthea: 'none' } },
      { id: 'CH1_S03_D005', speaker: 'lysthea', expression: 'panicked', text: 'Syukurlah... Maaf mengganggu selarut ini. Tapi bisakah kau melihat benda ini sebentar?!', backgroundOverride: 'ch1/cg_ch1_s03_lys_arrive.webp', characterOverrides: { aeterna: 'none', lysthea: 'none' } },
      { id: 'CH1_S03_D006', speaker: 'aeterna', expression: 'neutral', text: 'Dia menyodorkan sebuah bola kristal logam ke atas meja. Intinya retak dan memancarkan kilatan energi biru yang sangat liar.', backgroundOverride: 'ch1/cg_core_slam.webp', characterOverrides: { aeterna: 'none', lysthea: 'none' } },
      { id: 'CH1_S03_D007', speaker: 'lysthea', expression: 'panicked', text: 'Ini kristal core dari Defense Server distrik ketujuh. Pelindung distrik ini akan runtuh kalau sistemnya gagal me-reboot!', backgroundOverride: 'ch1/cg_core_slam.webp', characterOverrides: { aeterna: 'none', lysthea: 'none' } },
      ...
      { id: 'CH1_S03_D010', speaker: 'aeterna', expression: 'neutral', text: 'Dalam beberapa detik, cahaya liar itu padam. Sirkuit sihir di dalamnya kembali tersambung dan berputar mulus.', backgroundOverride: 'ch1/cg_casual_repair.webp' },
      { id: 'CH1_S03_D011', speaker: 'aeterna', expression: 'neutral', text: 'Sudah ku-patch. Sistem pelindungnya seharusnya otomatis online lagi sekarang.', backgroundOverride: 'ch1/cg_ch1_s03_lys_shock.webp', characterOverrides: { aeterna: 'none', lysthea: 'none' } },
      { id: 'CH1_S03_D012', speaker: 'lysthea', expression: 'shocked', text: '...Hah?', backgroundOverride: 'ch1/cg_ch1_s03_lys_shock.webp', characterOverrides: { aeterna: 'none', lysthea: 'none' } },
      { id: 'CH1_S03_D013', speaker: 'lysthea', expression: 'shocked', text: '(Tidak mungkin... Menulis ulang konfigurasi Origin Rune tanpa merapal mantra?! Bahkan divisi elitku butuh waktu berhari-hari untuk kasus ini!)', backgroundOverride: 'ch1/cg_ch1_s03_lys_shock.webp', characterOverrides: { aeterna: 'none', lysthea: 'none' } },
  ...
  // SCENE 4: THE REVELATION
  {
    ...
    dialogues: [
      { id: 'CH1_S04_D001', speaker: 'system', expression: 'neutral', text: '*CRASH!!!* Kaca jendela khusus bengkel pecah berkeping-keping.', autoAdvance: true, autoAdvanceDelay: 1000, backgroundOverride: 'ch1/cg_ch1_s04_assassin_entry.webp', characterOverrides: { aeterna: 'none', lysthea: 'none', abyssal_assassin: 'none' } },
      { id: 'CH1_S04_D002', speaker: 'abyssal_assassin', expression: 'menacing', text: 'Ketemu kau... Relik itu... Hancurlah bersamanya!', backgroundOverride: 'ch1/cg_ch1_s04_assassin_entry.webp', characterOverrides: { aeterna: 'none', lysthea: 'none', abyssal_assassin: 'none' } },
      { id: 'CH1_S04_D003', speaker: 'lysthea', expression: 'cool', text: 'Awas! Mundur, Engineer! Biar aku yang menanganinya!', backgroundOverride: 'ch1/cg_ch1_s04_lys_protect.webp', characterOverrides: { aeterna: 'none', lysthea: 'none', abyssal_assassin: 'none' } },
      ...
      { id: 'CH1_S04_D005', speaker: 'aeterna', expression: 'neutral', text: '(Dalam hati) Lebih baik aku cabut saja root access iblis ini secara manual.', backgroundOverride: 'ch1/cg_ch1_s04_aeterna_authority.webp', characterOverrides: { aeterna: 'none', lysthea: 'none', abyssal_assassin: 'none' } },
      ...
      { id: 'CH1_S04_D007', speaker: 'abyssal_assassin', expression: 'terrified', text: 'T-Tekanan ini... Root Access?! Tidak mungkin... Kau—', backgroundOverride: 'ch1/cg_dust_snap.webp', characterOverrides: { abyssal_assassin: 'none', aeterna: 'none', lysthea: 'none' } },
      { id: 'CH1_S04_D008', speaker: 'narrator', expression: 'neutral', text: 'Sebelum iblis itu menyelesaikan kalimatnya, tubuhnya terurai menjadi untaian kode cahaya, lalu hancur sepenuhnya menjadi debu merah.', backgroundOverride: 'ch1/cg_dust_snap.webp', characterOverrides: { abyssal_assassin: 'none', aeterna: 'none', lysthea: 'none' } },
      { id: 'CH1_S04_D009', speaker: 'lysthea', expression: 'crying', text: 'Hak Akses Mutlak ini... Otoritas dari inti penciptaan...', backgroundOverride: 'ch1/cg_ch1_s04_lys_crying.webp', characterOverrides: { abyssal_assassin: 'leave', aeterna: 'none', lysthea: 'none' } },
      { id: 'CH1_S04_D010', speaker: 'lysthea', expression: 'crying', text: 'Anda... Anda adalah The Weaver of Fate? Sang Arsitek Utama yang merancang dunia ini sepuluh ribu tahun yang lalu?', backgroundOverride: 'ch1/cg_ch1_s04_lys_crying.webp', characterOverrides: { abyssal_assassin: 'leave', aeterna: 'none', lysthea: 'none' } },
      { id: 'CH1_S04_D011', speaker: 'aeterna', expression: 'neutral', text: 'Aku menghela napas, menatap wanita di depanku. Pancaran energinya yang murni dan terstruktur... tidak salah lagi.', backgroundOverride: 'ch1/cg_ch1_s04_lys_crying.webp', characterOverrides: { abyssal_assassin: 'leave', aeterna: 'none', lysthea: 'none' } },
      { id: 'CH1_S04_D012', speaker: 'aeterna', expression: 'smile', text: 'Bangunlah. Lantainya kotor dan penuh pecahan kaca. Lama tidak berjumpa... Goddess of Order.', backgroundOverride: 'ch1/cg_ch1_s04_aeterna_smile.webp', characterOverrides: { abyssal_assassin: 'leave', aeterna: 'none', lysthea: 'none' } },
      { id: 'CH1_S04_D013', speaker: 'lysthea', expression: 'shocked', text: 'Anda... mengenali saya?', backgroundOverride: 'ch1/cg_ch1_s04_aeterna_smile.webp', characterOverrides: { aeterna: 'none', lysthea: 'none' } },
