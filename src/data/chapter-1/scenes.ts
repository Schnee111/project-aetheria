...
export const scenes: Scene[] = [
  // SCENE 0: BUMI (Ruang Kerja / Kantor)
  {
    ...
    dialogues: [
      ...
      { id: 'CH1_S00_D002', speaker: 'aeterna', expression: 'neutral', text: 'Menjadi manusia biasa itu ternyata menyenangkan. Tidak perlu memikirkan keseimbangan kosmis.' },
      { id: 'CH1_S00_D003', speaker: 'aeterna', expression: 'neutral', text: 'Di Aetheria dulu, satu jentikan jariku bisa menghancurkan galaksi. Di Bumi, aku harus mem-fix bug di baris 402 agar tidak dimarahi manager.' },
  ...
  // SCENE 1C: BUMI (Black Screen / Game Over)
  {
    ...
    dialogues: [
      ...
      { id: 'CH1_S01C_D002', speaker: 'aeterna', expression: 'neutral', text: 'Mati ditabrak truk di tengah senja seindah ini adalah metode kepulangan yang sangat klise dan tidak kreatif.' },
      { id: 'CH1_S01C_D003', speaker: 'aeterna', expression: 'neutral', text: 'Yah, sudahlah. Sepertinya masa "cuti" fana-ku di Bumi sudah habis.' }
    ],
    unlockEvidenceIds: [],
  ...
  // SCENE 1D: AETHERIA (Reincarnation Slideshow)
  {
    ...
    dialogues: [
      ...
      { id: 'CH1_S01D_D004', speaker: 'aeterna', expression: 'neutral', text: 'Saat wadah fanaku di Bumi kedaluwarsa, jiwaku secara otomatis tertarik kembali ke alam semesta asalku, Aetheria.', backgroundOverride: 'bg_isekai_baby.png', autoAdvance: true, autoAdvanceDelay: 3500 },
      { id: 'CH1_S01D_D005', speaker: 'aeterna', expression: 'neutral', text: 'Aku bereinkarnasi dengan wujud dan usia tubuh 23 tahun. Di bawah asuhan orang tua angkatku yang hangat...', backgroundOverride: 'bg_magitech_learning.png', autoAdvance: true, autoAdvanceDelay: 3000 },
      { id: 'CH1_S01D_D006', speaker: 'aeterna', expression: 'neutral', text: 'Di bengkel kecil milik merekalah, aku memilih takdir baruku: pensiun sebagai The Prime Deity, dan hidup santai sebagai mekanik kelas bawah.', backgroundOverride: 'bg_magitech_learning.png', autoAdvance: true, autoAdvanceDelay: 3500 }
    ],
    unlockEvidenceIds: [],
  ...
  // SCENE 2A: AETHERIA (Bengkel Magitech - Monolog Aeterna)
  {
    ...
    dialogues: [
      { id: 'CH1_S02A_D001', speaker: 'aeterna', expression: 'neutral', text: '10.000 tahun telah berlalu di Aetheria sejak aku meninggalkan tahtaku untuk "liburan" ke Bumi.' },
      { id: 'CH1_S02A_D002', speaker: 'aeterna', expression: 'neutral', text: 'Dunia yang dulu kutinggalkan telah berevolusi. Sistem sihir (*Rune-crafting*) yang kudesain kini berpadu dengan teknologi menjadi *Magitech*.' },
      { id: 'CH1_S02A_D003', speaker: 'aeterna', expression: 'neutral', text: 'Dan sejujurnya? Aku sangat menyukai perkembangannya. Ini berarti mereka sudah bisa mandiri tanpa campur tanganku.' },
      { id: 'CH1_S02A_D004', speaker: 'aeterna', expression: 'neutral', text: 'Sekarang aku bisa menikmati hidup sebagai Low-class Magitech Engineer, tidur siang sesukaku, jauh dari doa-doa berisik umat manusia.' }
    ],
    unlockEvidenceIds: [],
  ...
  // SCENE 2B: AETHERIA (Bel Berbunyi - Kedatangan Elf)
  {
    ...
    dialogues: [
      ...
      { id: 'CH1_S02B_D008', speaker: 'aeterna', expression: 'smug', text: 'Tentu saja cepat. Sebagai pencipta arsitektur dunia ini, aku memiliki "Root Access". Merangkai Rune itu sama mudahnya dengan anak TK menyusun balok.', backgroundOverride: 'bg_mechanic_shop_corner.png', characterOverrides: { elf_neighbor: 'leave' } },
  ...
  // SCENE 3: TAMU TAK DIUNDANG
  {
    ...
    dialogues: [
      ...
      { id: 'CH1_S03_D006', speaker: 'aeterna', expression: 'neutral', text: 'Wanita berjubah basah kuyup itu membanting sebuah bola kristal logam ke mejaku. Energinya bocor liar.', backgroundOverride: 'bg_mechanic_shop_door_pov.png' },
      { id: 'CH1_S03_D007', speaker: 'lysthea', expression: 'hidden', text: 'Ini kristal core dari Defense Server distrik ketujuh! Retak parah karena serangan mendadak Abyss!', backgroundOverride: 'bg_mechanic_shop_broken.png' },
      { id: 'CH1_S03_D008', speaker: 'lysthea', expression: 'hidden', text: 'Pelindung distrik ini akan runtuh dalam hitungan menit kalau benda ini mati, dan Abyss sudah mencium baunya! Bisakah kau menstabilkannya setidaknya selama satu jam?!', backgroundOverride: 'bg_mechanic_shop_broken.png' },
      { id: 'CH1_S03_D009', speaker: 'aeterna', expression: 'lazy', text: 'Sambil mengunyah roti lapis, aku menyentuhkan ibu jariku ke atas kristal yang retak itu tanpa mengalihkan pandangan dari majalah.', audioSrc: '/assets/audio/sfx/magic_repair.ogg', backgroundOverride: 'bg_mechanic_shop_door_pov.png' },
      { id: 'CH1_S03_D010', speaker: 'aeterna', expression: 'neutral', text: 'Aku menggambar satu simbol kuno (*Origin Rune*) secara kasual. Dalam sekejap mata, cahaya liar itu padam. Sirkuit kembali tersambung sempurna.', backgroundOverride: 'bg_mechanic_shop_door_pov.png' },
      { id: 'CH1_S03_D011', speaker: 'aeterna', expression: 'smug', text: 'Selesai. Sepuluh Silver Coins.', backgroundOverride: 'bg_mechanic_shop_door_pov.png' },
      { id: 'CH1_S03_D012', speaker: 'lysthea', expression: 'shocked', text: '...Apa?', backgroundOverride: 'bg_mechanic_shop_broken.png' },
      { id: 'CH1_S03_D013', speaker: 'lysthea', expression: 'shocked', text: '(Tidak mungkin... Origin Rune? Bahkan aku butuh waktu seminggu penuh membedah Rune sekompleks ini! Siapa Engineer pemalas ini sebenarnya?!)', backgroundOverride: 'bg_mechanic_shop_broken.png' }
    ],
    unlockEvidenceIds: [],
    nextSceneId: 'CH1_S04',
  },
  ...
  // SCENE 4: THE REVELATION
  {
    ...
    dialogues: [
      ...
      { id: 'CH1_S04_D004', speaker: 'aeterna', expression: 'smug', text: 'Tiga puluh Gold Coins.', backgroundOverride: 'bg_mechanic_shop_door_pov.png' },
      { id: 'CH1_S04_D005', speaker: 'lysthea', expression: 'cool', text: 'Apa?' },
      { id: 'CH1_S04_D006', speaker: 'aeterna', expression: 'sigh', text: 'Harga pintu dan jendelaku yang baru saja kau hancurkan. Dan kau mengotori lantainya.', backgroundOverride: 'bg_mechanic_shop_door_pov.png' },
      { id: 'CH1_S04_D007', speaker: 'narrator', expression: 'neutral', text: 'Tanpa beranjak dari kursinya, Aeterna menjentikkan jarinya malas. Seketika, Aura of the Prime (Otoritas Mutlak) menekan seluruh ruangan.', backgroundOverride: 'bg_mechanic_shop_door_pov.png' },
      ...
      { id: 'CH1_S04_D009', speaker: 'narrator', expression: 'neutral', text: 'Sebelum iblis itu menyelesaikan kalimatnya, jentikan jari Aeterna mengubahnya menjadi partikel debu halus.', characterOverrides: { abyssal_assassin: 'leave' } },
      { id: 'CH1_S04_D010', speaker: 'lysthea', expression: 'crying', text: 'Otoritas Mutlak ini... Anda adalah The Weaver of Fate? The Prime Deity?' },
      ...
      { id: 'CH1_S04_D012', speaker: 'aeterna', expression: 'lazy', text: 'Terima kasih atas kerja kerasmu. Tapi, jika kau mau tutup mulut tentang identitasku, aku akan membetulkan Temple Server milikmu secara gratis. Sepakat? Aku benar-benar harus kembali tidur siang.', backgroundOverride: 'bg_mechanic_shop_corner.png' },
      { id: 'CH1_S04_D013', speaker: 'aeterna', expression: 'smug', text: 'Dia terdiam menatapku, lalu membuang muka dengan cemberut kecil di wajahnya yang merona merah. Sepertinya kesepakatan kami berjalan lancar.', backgroundOverride: 'bg_mechanic_shop_corner.png' }
    ],
    unlockEvidenceIds: [],
  }
];
