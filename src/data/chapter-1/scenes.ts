...
export const scenes: Scene[] = [
  ...
  // SCENE 2B: AETHERIA (Doorbell Rings - Elf Arrives)
  {
    ...
    dialogues: [
      ...
      { id: 'CH1_S02B_D003', speaker: 'aeterna', expression: 'sigh', text: 'Aku menghela napas, meletakkan ujung telunjukku langsung pada kristal sirkuit mana yang hangus itu.', textEn: 'I let out a sigh, placing my index finger directly on the charred mana circuit crystal.', backgroundOverride: 'ch1/bg_mechanic_shop_door_pov.webp' },
  ...
  // SCENE 4: THE REVELATION
  {
    ...
    dialogues: [
      ...
      { id: 'CH1_S04_D004', speaker: 'aeterna', expression: 'sigh', text: '(Dalam hati) Kalau kubiarkan dia bertarung, bengkel ini akan rata dengan tanah. Kaca jendela itu saja sudah merugikanku tiga puluh Gold Coins...', textEn: '(Thinking) If I let her fight, this workshop will be leveled. That window alone already cost me thirty Gold Coins...', characterOverrides: { aeterna: 'sigh', lysthea: 'cool' } },
      { id: 'CH1_S04_D005', speaker: 'aeterna', expression: 'neutral', text: '(Dalam hati) Lebih baik aku cabut saja root access iblis ini secara manual.', textEn: '(Thinking) Might as well rip this demon\'s root access out manually.', backgroundOverride: 'ch1/cg_ch1_s04_aeterna_authority.webp', characterOverrides: { aeterna: 'none', lysthea: 'none', abyssal_assassin: 'none' } },
