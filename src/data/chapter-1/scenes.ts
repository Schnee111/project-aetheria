...
export const scenes: Scene[] = [
  ...
  // SCENE 4: THE REVELATION
  {
    ...
    dialogues: [
      ...
      { id: 'CH1_S04_D004', speaker: 'narrator', expression: 'sigh', text: '(Dalam hati) Kalau kubiarkan dia bertarung, bengkel ini akan rata dengan tanah. Kaca jendela itu saja sudah merugikanku tiga puluh Gold Coins...', textEn: '(Thinking) If I let her fight, this workshop will be leveled. That window alone already cost me thirty Gold Coins...', characterOverrides: { aeterna: 'sigh', lysthea: 'cool' } },
      { id: 'CH1_S04_D005', speaker: 'narrator', expression: 'neutral', text: '(Dalam hati) Lebih baik aku cabut saja root access iblis ini secara manual.', textEn: '(Thinking) Might as well rip this demon\'s root access out manually.', backgroundOverride: 'ch1/cg_ch1_s04_aeterna_authority.webp', characterOverrides: { aeterna: 'none', lysthea: 'none', abyssal_assassin: 'none' } },
