...
function App() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      // Intercept isekai transition
      if (currentScene.id === 'CH1_S01C' && newProgress.currentSceneId === 'CH1_S01D') {
        setScreen('isekai_transition');
      } else {
  ...
  }, [isComplete, screen, currentScene, setProgress, navigateFromScene, interruptedTarget, setScreen]);
